...
class Patient(object):
    ...
    def update(self):
        ...
        """
        # Step 1: Determine fate of each bacterium
        surviving_bacteria = []
        ...
        # Step 4: Return new bacteria population in the patient
...
def calc_pop_avg(populations, n):
    ...
    """
    data = [populations[i][n] for i in range(len(populations))] 
    return np.mean(data)
...
def simulation_without_antibiotic(num_bacteria,
    ...
    for trial_i in range(num_trials):
        bacteria = [SimpleBacteria(birth_prob, death_prob) for i in
                range(num_bacteria)]
...
class TreatedPatient(Patient):
    ...
    def update(self):
        ...
        # Step 2: Determine which bacteria survive based on antibiotic use
        ...
        # Step 5: Return new bacteria population in the patient
        self.bacteria = surviving_bacteria + child_bacteria
        return len(self.bacteria)
...
def simulation_with_antibiotic(num_bacteria,
    ...
    for trial_i in range(num_trials):
        ...
        # Create lists to hold trial data
        trial_data = [patient.get_total_pop()]
    ...
    # Plotting
    x_coords = list(range(time_steps_before_antibiotic +
        time_steps_after_antibiotic))
